    ...
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <div class="navbar__left">
                <a href="eggsSummary.php" onclick="toggle()">Egg Trays</a>
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                    ...
                    echo "['Trays Remaining', " . $remainingEggs . "],";

                    echo "['Trays Sold', " . $totalEggsSold . "],";
